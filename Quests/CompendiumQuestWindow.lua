...
function CompendiumQuestWindow:Constructor()
    ...
    self.LevelCaption:SetParent(self.MainPanel);
    ...
    self.ArcCaption:SetParent(self.MainPanel);
    ...
    self.ArcCaption:SetText("Filter By Arc:");
    
    self.SearchCaption=Turbine.UI.Label();
    self.SearchCaption:SetParent(self.MainPanel);
    ...
    local searchWidth = self.MainPanel:GetWidth()-(self.SearchCaption:GetWidth()+self.SearchCaption:GetLeft())-140;
    self.SearchBorder=Turbine.UI.Control();
    self.SearchBorder:SetParent(self.MainPanel);
    ...
    self.SearchText:SetParent(self.MainPanel);
    ...
    reset:SetParent( self.MainPanel );
    reset:SetText( "reset" );
    ...
    self.qlContainer:SetParent(self.MainPanel);
    self.qlContainer:SetPosition(5,106);
    self.qlContainer:SetSize((self.MainPanel:GetWidth()/2) - 7, self:GetHeight()-270);
    ...
    self.qdContainer:SetParent(self.MainPanel);
    ...
    self.commentsCtr:SetParent(self.MainPanel);
    self.commentsCtr:SetPosition(5,bottom);
    self.commentsCtr:SetSize(self.MainPanel:GetWidth()-7, self.MainPanel:GetHeight() - bottom - 50);
...
--    Turbine.Shell.WriteLine("Top: " .. self.qdContainer:GetTop() .. " Height: " .. self.qdContainer:GetHeight());
    ...
    self.ArcList:SetParent(self.MainPanel);
    self.ArcList:SetPosition(self.ArcCaption:GetLeft()+self.ArcCaption:GetWidth()+3,self.ArcCaption:GetTop()-3);
    self.ArcList:SetSize(self.MainPanel:GetWidth()-(self.ArcCaption:GetWidth()+self.ArcCaption:GetLeft())-95,20);
    ...
    self.ArcList:AddItem( '(Choose a Quest Arc)', '');
    ...
    self.LevelList:SetParent(self.MainPanel);
    self.LevelList:SetPosition(self.LevelCaption:GetLeft()+self.LevelCaption:GetWidth()+3,self.LevelCaption:GetTop()-3);
    self.LevelList:SetSize(self.MainPanel:GetWidth()-(self.LevelCaption:GetWidth()+self.LevelCaption:GetLeft())-95,20);
    ...
    self.ZoneList:SetParent(self.MainPanel);
    self.ZoneList:SetPosition(self.ZoneCaption:GetLeft()+self.ZoneCaption:GetWidth()+3,self.ZoneCaption:GetTop()-3);
    self.ZoneList:SetSize(self.MainPanel:GetWidth()-(self.ZoneCaption:GetWidth()+self.ZoneCaption:GetLeft())-95,20);
...
function CompendiumQuestWindow:ClearQuests()
...
function CompendiumQuestWindow:AddQuestDetail(text, hyperlink)
...
function CompendiumQuestWindow:SearchAndLoadQuests(searchText, zoneText, levelText, arcText)
...
function CompendiumQuestWindow:JoinIndex(a, b)
...
function CompendiumQuestWindow:LoadQuests(records)
...
function CompendiumQuestWindow:Reset() 
	self.searchDisabled = true;
